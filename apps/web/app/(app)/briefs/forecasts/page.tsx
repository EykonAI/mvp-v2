...
// transits, EIA inventories), hashed at issue and scored when they resolve.
  ...
  return (
    <div>
      ...
      <p style={{ fontSize: 12.5, color: 'var(--ink-dim)', margin: '0 0 18px', lineHeight: 1.5 }}>
        eYKON’s own forecasts — weekly chokepoint transits and EIA inventories — hashed at issue and scored when they resolve. Open calls are live now; resolved calls show the observed outcome and the Brier score. Every item opens to the full call, where you can recompute its SHA-256 hash in your own browser. This is the public track record.
      </p>
